...
public class PermissionsResolverManager implements PermissionsResolver {
	...
	public static PermissionsResolverManager getInstance() {
		if (!isInitialized()) throw new WEPIFRuntimeException("WEPIF has not yet been initialized!");
		return instance;
	}
	...
	protected Class<? extends PermissionsResolver>[] availableResolvers = new Class[] { PluginPermissionsResolver.class, PermissionsExResolver.class, bPermissionsResolver.class, GroupManagerResolver.class, NijiPermissionsResolver.class, DinnerPermsResolver.class, FlatFilePermissionsResolver.class };
	...
	public void setPluginPermissionsResolver(Plugin plugin) {
		if (!(plugin instanceof PermissionsProvider)) return;
