...
public class PermissionsExResolver extends DinnerPermsResolver {
	...
	public boolean hasPermission(OfflinePlayer player, String permission) {
		...
		if (permissible == null) return manager.has(player.getName(), permission, null);
		else return permissible.hasPermission(permission);
	}
	...
	public String[] getGroups(OfflinePlayer player) {
		...
		else return super.getGroups(player);
	}
