...
public class SignBlock extends BaseBlock implements TileEntityBlock {
	...
	public void setText(String[] text) {
		if (text == null) throw new IllegalArgumentException("Can't set null text for a sign");
		this.text = text;
	}
	...
	public void setNbtData(CompoundTag rootTag) throws DataException {
		...
		t = values.get("id");
		if (!(t instanceof StringTag) || !((StringTag) t).getValue().equals("Sign")) throw new DataException("'Sign' tile entity expected");
