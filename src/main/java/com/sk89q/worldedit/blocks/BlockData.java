...
public final class BlockData {
	...
	/** Cycle a block's data value. This usually goes through some rotational pattern depending on the
	 * block. If it returns -1, it means the id and data specified do not have anything to cycle to.
	 * 
	...
	public static int cycle(int type, int data, int increment) {
		if (increment != -1 && increment != 1) throw new IllegalArgumentException("Increment must be 1 or -1.");
	...
	/** Returns the data value for the next color of cloth in the rainbow. This should not be used if
	 * you want to just increment the data value.
	 * 
	 * @param data
	 * @return */
	...
	/** Returns the data value for the previous ext color of cloth in the rainbow. This should not be
	 * used if you want to just increment the data value.
	 * 
	 * @param data
	 * @return */
