...
public class BaseBlock extends Block {
	...
	public boolean equals(Object o) {
		...
		if (getType() != otherBlock.getType()) return false;
	...
	/** @param iter
	 * @return
	 * @deprecated This method is silly, use {@link #containsFuzzy(java.util.Collection, BaseBlock)}
	 *             instead. */
	@Deprecated
	public boolean inIterable(Iterable<BaseBlock> iter) {
		for (BaseBlock block : iter) {
			if (block.equalsFuzzy(this)) return true;
		}
		return false;
	}
	...
	public static boolean containsFuzzy(Collection<BaseBlock> collection, BaseBlock o) {
		...
		for (BaseBlock b : collection) {
			if (b.equalsFuzzy(o)) return true;
		}
		return false;
	}
}
