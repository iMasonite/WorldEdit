...
public class SkullBlock extends BaseBlock implements TileEntityBlock {
	...
	/** Construct the skull block with a given type. 0 - skeleton 1 - wither skelly 2 - zombie 3 -
	 * human 4 - creeper
	 * 
	 * @param data data value to set, controls placement
	...
	/** Construct the skull block with a given rotation and owner. The type is assumed to be player
	 * unless owner is null or empty.
	 * 
	 * @param data data value to set, controls placement
	...
	public void setNbtData(CompoundTag rootTag) throws DataException {
		...
		t = values.get("id");
		if (!(t instanceof StringTag) || !((StringTag) t).getValue().equals("Skull")) throw new DataException("'Skull' tile entity expected");
