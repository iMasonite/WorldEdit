...
/** Base matcher for the block filtering framework. Implementing classes can be used to filter blocks
 * to set or replace.
 * <p>
...
public interface Mask {
	...
	/** Given a block position, this method returns true if the block at that position matches the
	 * filter. Block information is not provided as getting a BaseBlock has unneeded overhead in most
	 * block querying situations (enumerating a chest's contents is a waste, for example).
	 * 
	 * @param editSession
	 * @param pos
	 * @return */
