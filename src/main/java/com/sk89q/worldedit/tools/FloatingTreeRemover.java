...
public class FloatingTreeRemover implements BlockTool {
	 ...
	 * @return a set containing all blocks in the tree/shroom or null if this is not a floating
	 *         tree/shroom. */
				...
				if (visited.add(next)) {
					switch (world.getBlockType(next)) {
						...
						default:
							...
							else // log/shroom touching a wall/the ground => this is not a floating tree, bail out
							return null;
					} // switch
				} // if
			} // for
