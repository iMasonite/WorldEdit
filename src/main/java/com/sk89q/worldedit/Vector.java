...
public class Vector implements Comparable<Vector> {
	...
	public boolean isCollinearWith(Vector other) {
		if (x == 0 && y == 0 && z == 0) // this is a zero vector
		return true;
		...
		if (otherX == 0 && otherY == 0 && otherZ == 0) // other is a zero vector
		return true;
		...
		if (!Double.isNaN(quotientY)) return other.equals(multiply(quotientY));
