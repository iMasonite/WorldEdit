...
public class ToolCommands {
	...
	public void tree(CommandContext args, LocalSession session, LocalPlayer player, EditSession editSession) throws WorldEditException {
		...
		TreeGenerator.TreeType type = args.argsLength() > 0 ? type = TreeGenerator.lookup(args.getString(0)) : TreeGenerator.TreeType.TREE;
	...
	@Command(aliases = { "floodfill", "flood" },
			usage = "<pattern> <range>",
	...
	@Command(aliases = { "lrbuild", "/lrbuild" },
