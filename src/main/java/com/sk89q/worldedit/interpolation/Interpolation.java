...
public interface Interpolation {
	/** Sets nodes to be used by subsequent calls to {@link #getPosition(double)} and the other
	 * methods.
	 * 
	 * @param nodes */
	...
	/** Gets the result of &int;<sub>a</sub><sup style="position: relative; left: -1ex">b</sup>|f'(t)|
	 * dt.<br />
