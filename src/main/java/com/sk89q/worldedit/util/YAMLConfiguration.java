...
public class YAMLConfiguration extends LocalConfiguration {
	...
	public void load() {
		...
		defaultMaxPolygonalPoints = Math.max(-1, config.getInt("limits.max-polygonal-points.default", defaultMaxPolygonalPoints));
		...
		useInventoryCreativeOverride = config.getBoolean("use-inventory.creative-mode-overrides", useInventoryCreativeOverride);
