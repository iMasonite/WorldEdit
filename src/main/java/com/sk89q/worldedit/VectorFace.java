...
/** Represents the adjacency of one vector to another. Works similarly to Bukkit's BlockFace class.
 * 
 * @author wizjany */
public enum VectorFace {
	...
	public static VectorFace fromMods(int modX2, int modY2, int modZ2) {
		for (VectorFace face : values()) {
			if (face.getModX() == modX2 && face.getModY() == modY2 && face.getModZ() == modZ2) return face;
		}
