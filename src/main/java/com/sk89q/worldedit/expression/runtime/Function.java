...
public class Function extends Node {
	 ...
	 * and on functions with side-effects. */
	...
	protected static final double invokeMethod(Method method, Object[] args) throws EvaluationException {
		try {
			...
			if (e.getTargetException() instanceof EvaluationException) throw (EvaluationException) e.getTargetException();
	...
	public RValue optimize() throws EvaluationException {
		...
		if (optimizable) return new Constant(position, invokeMethod(method, optimizedArgs));
