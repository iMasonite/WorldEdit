...
public class WorldVector2D extends Vector2D {
	...
	public boolean equals(Object obj) {
		if (!(obj instanceof WorldVector2D)) return false;
		WorldVector2D other = (WorldVector2D) obj;
		return other.world.equals(world) && other.x == this.x && other.z == this.z;
	...
	@Override
	public int hashCode() {
		return (world.hashCode() >> 7) ^ ((int) (Double.doubleToLongBits(x) ^ (Double.doubleToLongBits(x) >>> 32)) >> 13) ^ (int) (Double.doubleToLongBits(z) ^ (Double.doubleToLongBits(z) >>> 32));
	}
}
