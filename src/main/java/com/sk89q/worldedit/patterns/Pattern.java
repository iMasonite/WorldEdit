...
/** Used to get the block to set. This can be used to implement a pattern for when setting a region
 * with blocks.
 * 
 * @author sk89q */
public interface Pattern {
	/** Get a block for a position. This return value of this method does not have to be consistent for
	 * the same position.
	 * 
	 * @param pos
	 * @return */
