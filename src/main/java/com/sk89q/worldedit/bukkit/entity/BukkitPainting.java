...
public class BukkitPainting extends BukkitEntity {
	...
	/** Queue the painting to be spawned at the specified location. This operation is delayed so that
	 * the block changes that may be applied can be applied before the painting spawn is attempted.
	 * 
