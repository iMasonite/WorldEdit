...
public class CuboidRegionSelector implements RegionSelector, CUIRegion {
	...
	public boolean selectPrimary(Vector pos) {
		if (pos1 != null && (pos.compareTo(pos1) == 0)) return false;
	...
	public boolean selectSecondary(Vector pos) {
		if (pos2 != null && (pos.compareTo(pos2)) == 0) return false;
	...
	public CuboidRegion getRegion() throws IncompleteRegionException {
		if (pos1 == null || pos2 == null) throw new IncompleteRegionException();
