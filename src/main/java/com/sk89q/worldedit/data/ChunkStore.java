...
public abstract class ChunkStore {
	 ...
	 * @throws IOException */
	public abstract CompoundTag getChunkTag(Vector2D pos, LocalWorld world) throws DataException, IOException;
	...
	public Chunk getChunk(Vector2D pos, LocalWorld world) throws DataException, IOException {
		...
		if (tags.containsKey("Sections")) return new AnvilChunk(world, tag);
